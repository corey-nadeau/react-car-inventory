...
function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-red-500 p-10">
        <div className="flex items-center flex-shrink-0 text-white mr-6">
            <Link to='/' className='font-semibold text-xl tracking-tight'>Corey's Car Inventory</Link>
        </div>
        <div className="block">
            <button 
                onClick={dropDown}
                className="flex items-center px-3 py-2 text-white 
                border rounded border-white-400 hover:text-black hover:border-white"
                >
